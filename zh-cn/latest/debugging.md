...
![image](images/debugging_error.png)
...
Windows only: To debug UDFs, just check the `Debug UDFs` in the [Add-in & Settings](addin.md#add-in-settings), at the top of the xlwings VBA module.
...
![image](images/udf_debugging.png)
