...
* 若要在商業環境中免費試用 xlwings PRO，請申請試用授權金鑰：\\ [https://www.xlwings.org/trial](https://www.xlwings.org/trial)
* 若要在試用期結束後於商業環境中使用 xlwings PRO，您需要註冊付費方案（這些方案包含額外服務，例如支援和建立一鍵安裝程式的功能）：\\ [https://www.xlwings.org/pricing](https://www.xlwings.org/pricing)
