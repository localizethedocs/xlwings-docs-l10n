...
1. Most importantly, open an issue on [GitHub](https://github.com/xlwings/xlwings/issues).
...
2. Workaround: in essence, xlwings is just a smart wrapper around [pywin32](https://github.com/mhammond/pywin32/) on
   Windows and [appscript](https://github.com/hhas/appscript) on Mac. You can access the underlying objects by calling
   the `api` property:
   ```pycon
